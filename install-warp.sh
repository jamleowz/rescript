...
clear
cd /usr/bin
wget -O menu-warp "https://raw.githubusercontent.com/jamleowz/rescript/main/menu-warp.sh"
wget -O warp "https://raw.githubusercontent.com/amleowz/rescript/main/warp.sh"
chmod +x warp
chmod +x menu-warp
cd
